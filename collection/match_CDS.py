...
def identify_protein_matches( parameters ):
	...
	p = subprocess.Popen( args=db_command1, shell=True )
	p.communicate()
	p = subprocess.Popen( args=db_command2, shell=True )
	p.communicate()
	...
	p = subprocess.Popen( args=BLAST_command1, shell=True )
	p.communicate()
	...
	p = subprocess.Popen( args=BLAST_command2, shell=True )
	p.communicate()
